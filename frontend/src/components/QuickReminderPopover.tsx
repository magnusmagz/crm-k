    ...
    <Popover className="relative">
      {({ close, open }) => (
        <>
          ...
          >
            <Popover.Panel className="fixed md:absolute z-50 inset-0 md:inset-auto md:mt-2 md:right-0 md:left-0 flex items-center justify-center md:block md:w-auto p-4 md:p-0">
              <div className="bg-white rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 overflow-hidden w-full max-w-sm md:max-w-sm">
