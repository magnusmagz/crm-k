...
const DraggableFAB: React.FC = () => {
  ...
  return (
    <>
      <div
        ref={fabRef}
        className={`fixed z-50 w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg flex items-center justify-center cursor-move transition-colors ${
